...
public class BrotherRoom_LOC : MonoBehaviour {


    public static void BroRoom()
    {
        int NUM;
        ...
        daycycle_loc.loc_DayCycle_name = "Img/Home/BroRoom/bro_room_";
        ...
        {
            //описание локации
            MMOstart.lang_locname = "Дом / Комната брата";
            MMOstart.lang_locTEXT1 = "В этой комнате живет ваш брат.";
            //переходы
        ...
        {
            //описание локации
            MMOstart.lang_locname = "House / Brother room";
            MMOstart.lang_locTEXT1 = "Your brother lives in this room.";
            //переходы
